              ...
              {profileOpen ? (
                <div className="absolute right-0 mt-2 w-64 overflow-hidden rounded-xl border border-slate-200 bg-white text-slate-900 shadow-xl">
                  ...
                  <div className="p-2 space-y-1">
                    <label className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm cursor-pointer hover:bg-slate-100">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm text-red-600 hover:bg-red-50 w-full disabled:opacity-50"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm hover:bg-slate-100 w-full"
                    >
                      <svg className="h-4 w-4 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
