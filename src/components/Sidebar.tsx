...
function Item({ active, label, onClick, icon, badge }: ItemProps) {
  return (
    <button
      ...
      className={
        active
          ? 'w-full flex items-center gap-3 rounded-lg bg-emerald-50 px-3 py-2.5 text-sm font-medium text-emerald-700 transition-colors'
        ...
        <div className="p-4 border-b">
          <div className="flex items-center gap-3">
            {logoUrl ? (
              ...
              <div className="h-10 w-10 rounded-lg bg-gradient-to-br from-emerald-600 to-teal-700 flex items-center justify-center text-white font-bold text-lg">
                {logoLetter}
              </div>
            )}
            <div>
